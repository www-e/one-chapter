...
interface EditTaskModalProps {
  visible: boolean;
  onDismiss: () => void;
  onSubmit: (data: { id: string; title: string; description: string | undefined; categoryId: string }) => void;
  categories: Category[];
  task: Task | null;
  isLoading?: boolean;
}
...
export function EditTaskModal({ visible, onDismiss, categories, task, onSubmit, isLoading = false }: EditTaskModalProps) {
  ...
  const selectedCategoryColor = selectedCategoryData?.color || colors.primary;
              ...
              <View style={[styles.modalBlur, { backgroundColor: colors.surface, borderColor: colors.glass.border }]}>
                ...
                <View style={styles.header}>
                  ...
                  <View style={styles.headerText}>
                    <Text style={[styles.headerTitle, { color: colors.text.primary }]}>Edit Task</Text>
                    <Text style={[styles.headerSubtitle, { color: colors.text.secondary }]}>Update your task details</Text>
                  </View>
                  ...
                  {!isValid || isLoading ? (
                    ...
                    >
                      {isLoading ? (
                        ...
                        <Text style={[styles.disabledButtonText, { color: colors.text.tertiary }]}>Save</Text>
                      )}
                    </Pressable>
                  ) : (
                    <Pressable
